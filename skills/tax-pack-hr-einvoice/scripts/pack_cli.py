...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Croatia eInvoice pack via tax-parser-core.")
    ...
    test_parser.add_argument("--extractor", default="hr-einvoice-legacy")
    ...
    gate.add_argument("--extractor", default="hr-einvoice-legacy")
