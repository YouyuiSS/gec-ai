...
10. Run the harness quality gate:
   - `python scripts/harness/quality_gate.py --pdf <pdf> --extractor <name> --outdir <outdir>`
11. If the extractor still fails badly, optionally run:
...
13. If a trusted baseline exists, compare against it:
